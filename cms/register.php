  ...
  <body>
    ...
    <section class="container p-t-30">
		...
		<div class="col-md-12">	  
			...
			<h2>Um Deine Liste zu speichern, melde Dich bitte an: </h2>
			<div style="margin-bottom:20px;">Du kannst diesen Schritt auch &uuml;berspringen und Deine Liste direkt &uuml;ber einen Link erreichen. Allerdings kann Dann jeder, der den Link kennt, die Liste ver&auml;ndern.</div>
				<input type="text" name="listname" class="form-control" style="" placeholder="Benutzername"  maxlength="200" required>
				<bR>
				<input type="text" name="listname" class="form-control" style="" placeholder="Passwort"  maxlength="200" required>
				<bR>
				<input type="text" name="listname" class="form-control" style="" placeholder="Passwort wiederholen"  maxlength="200" required>
				<bR>
				<button class="btn btn-primary" type="button" style="">Speichern</button>
				<button class="btn btn-primary" type="button" style="">&Uuml;berspringen</button>
				<div style="margin-top:20px;">Du hast schon ein Benutzerkonto? <a href="">Zum Login.</a></div>
			</div>
